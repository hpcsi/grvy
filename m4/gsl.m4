...
[
dnl supporting both --with-gsl and --with-gsl-prefix
AC_ARG_WITH(gsl,[  --with-gsl=PFX   Prefix where GSL is installed (optional)],[
            gsl_prefix="$withval"
            GSL_PREFIX=$withval
            AC_SUBST(GSL_PREFIX)], gsl_prefix="")
AC_ARG_WITH(gsl-prefix,[  --with-gsl-prefix=PFX   Prefix where GSL is installed (optional)],[
            gsl_prefix="$withval"
            GSL_PREFIX=$withval
            AC_SUBST(GSL_PREFIX)], gsl_prefix=$gsl_prefix) dnl if not found, use whatever --with-gsl set.
