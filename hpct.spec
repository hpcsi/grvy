...
./configure FC=gfortran F77=gfortran CC=gcc CXX=g++ --prefix=%{INSTALL_DIR} --with-boost=%{BOOST_DIR}
make
...
setenv HPCT_INC %{INSTALL_DIR}/include
setenv HPCT_LIB %{INSTALL_DIR}/lib
